    ...
    public int execute(SipSession session)
    {
        ...
        else 
        {
           ...
           if(null != recv)
           {
               ...
               {
                   //session.terminated(toString() +",but got message with method:" + method);
               ...
               if(response >= 0)
               {
                   ...
                   {
                       //session.terminated(toString() +",but got a request:" + recv);
                   ...
                   {
                       //session.terminated(toString() + ", but got response " + res.getStatusCode());
                       //return 0;
